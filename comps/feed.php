...
if($_SERVER['PHP_SELF']!="/view.php"){
 echo"<div class='load_more_posts'><div class='normal'>Load More Posts</div><div class='loader' hide><img src='load.gif' height='32' width='32'/><span>Loading More Posts</span></div></div>";
}
?>
