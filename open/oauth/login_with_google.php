...
$client->client_id = '575210830217-2s0n7ik12s4d0pjju408efc37o5p0kgu.apps.googleusercontent.com';
$client->client_secret = 'fO7sNzuvEyUWadxZ4HfNU6PK';
...
if($success){
 ...
 if($sql->rowCount()!=0){
  ...
  $r_salt=ras(25);
  $site_salt=")%*@*%!&%^)#@-_+`=~";
  $salted_hash=hash('sha256',"oauth_985_login".$site_salt.$r_salt);
