  ...
  <?php if(loggedIn){ ?>
    <div class="curuserinfo">
      ...
      <div id="short_profile" class="c_c">
        ...
        <div class="bottom">
          <a href="<?php echo HOST;?>/me" class="button" style="position:absolute;left: 10px;">Account</a>
          <a href="<?php echo HOST;?>/login?logout=true" class="button b-red" style="position:absolute;right: 10px;">Log Out</a>
        </div>
      </div>
    </div>
