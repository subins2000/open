...
<html lang="en">
  ...
  <body>
    ...
    <p>
     The requested URL was not found on this server.<br/><ins>Maybe you have clicked a wrong link.</ins>
    </p>
    <a onclick="window.history.go(-1)">Go Back</a>, <a  onclick="window.location='http://'+window.location.host">Home Page</a>
  </body>
</html>
