...
window.post=function(url, data, success, error, onLoad, form){
 /* The default messages */
 d = {success : "Task Completed", error : "Task Failed."};
 if(success != null){
 	d.success = success;
 }
 if(error != null){
...
$("#change_picture").live("click",function(){
 dialog(ht+"/me/changeProfilePicture.php");
});
