...
<html><head>
 ...
 <div class="content" style="width:320px;">
  ...
  <div id="social" style="<?if(isset($_POST['submit']) || isset($_POST['verify'])){?>display:none;<?}?>">
   <center>
    <a href="oauth/login_with_facebook" style="display: inline-block;height: 43px;margin: 0px;padding: 0px 20px 0px 52px;font-family: 'Ubuntu', sans-serif;font-size: 18px;font-weight: 400;color: #fff;line-height: 41px;background: #3b579d url(//open.subinsb.com/cdn/img/fb_icon.png) no-repeat 14px 8px scroll;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;text-decoration: none;cursor:pointer;margin-right:5px;">Login With Facebook</a><cl/>
